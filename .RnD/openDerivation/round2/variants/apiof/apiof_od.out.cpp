...
namespace od_view {
  template<typename API, typename... OO> struct APIOf : hapi::APIOf<API,OO...> {using Base=hapi::APIOf<API,OO...>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<OO...,API>>, "duplicate layer in APIOf");};
}

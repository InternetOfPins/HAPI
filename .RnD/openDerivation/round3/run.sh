...
for c in $(cxxs); do
  for f in base_chain named_chain component closed_layer def_expand def_namespaces final_type final_layer distinct_args rules_ok ctors self family identity user_super dependent label_hazard; do

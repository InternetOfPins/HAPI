...
#include "identity.h"
struct G  : A:(B:final C) {};                                  // parenthesized right grouping: flattened
struct Y  : Any:final X {};                                    // X (a named composition) as the last operand
struct Y2 : Any:A:B:final C {};
template<typename... PP> struct F : (PP : ... : final C) {};

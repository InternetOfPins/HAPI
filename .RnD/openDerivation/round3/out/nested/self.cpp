...
struct X : Self::Part<Term> {using Base=Self::Part<Term>; using Base::Base;};
struct Y : Self::Part<Self::Part<Term>> {using Base=Self::Part<Self::Part<Term>>; using Base::Base;};    // the same open class twice in one chain: two distinct layers
int main() {

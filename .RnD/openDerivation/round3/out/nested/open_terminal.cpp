...
struct Z : A::Part<B::Part<od::Nil>> {using Base=A::Part<B::Part<od::Nil>>; using Base::Base;};
template<typename... PP> struct ZF : od::FoldT<od::Nil,PP...,B> {using Base=typename od::FoldT<od::Nil,PP...,B>; using Base::Base;};
int main() {
  Z z; ZF<A> zf; ZF<> ze;

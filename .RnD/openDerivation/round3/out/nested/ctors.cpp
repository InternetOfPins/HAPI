...
struct X : Pass::Part<Pass2::Part<Term>> {using Base=Pass::Part<Pass2::Part<Term>>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<Pass,Pass2,Term>>, "duplicate layer in X"); static_assert(hapi::BuildRules<hapi::Chain<>,hapi::Chain<Term,Pass,Pass2>>::rules(), "HAPI: validation failed in X");};
struct Y : Offset::Part<Pass2::Part<Term>> {using Base=Offset::Part<Pass2::Part<Term>>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<Offset,Pass2,Term>>, "duplicate layer in Y"); static_assert(hapi::BuildRules<hapi::Chain<>,hapi::Chain<Term,Offset,Pass2>>::rules(), "HAPI: validation failed in Y");};
struct E : Explicit::Part<Term> {using Base=Explicit::Part<Term>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<Explicit,Term>>, "duplicate layer in E"); static_assert(hapi::BuildRules<hapi::Chain<>,hapi::Chain<Term,Explicit>>::rules(), "HAPI: validation failed in E");};

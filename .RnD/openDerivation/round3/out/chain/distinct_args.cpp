...
struct Z : hapi::Chain<Add<1>,Add<2>>::Part<Term> {using Base=hapi::Chain<Add<1>,Add<2>>::Part<Term>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<Add<1>,Add<2>,Term>>, "duplicate layer in Z");};

...
template<typename... PP> struct ZF : hapi::Chain<PP...,B>::template Part<od::Nil> {using Base=typename hapi::Chain<PP...,B>::template Part<od::Nil>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<PP...,B>>, "duplicate layer in ZF"); static_assert(hapi::BuildRules<hapi::Chain<>,hapi::Chain<PP...,B>>::rules(), "HAPI: validation failed in ZF");};
int main() {
  Z z; ZF<A> zf; ZF<> ze;

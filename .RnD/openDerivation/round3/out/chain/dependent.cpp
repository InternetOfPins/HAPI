...
struct U : hapi::Chain<Uses>::Part<Only> {using Base=hapi::Chain<Uses>::Part<Only>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<Uses,Only>>, "duplicate layer in U"); static_assert(hapi::BuildRules<hapi::Chain<>,hapi::Chain<Only,Uses>>::rules(), "HAPI: validation failed in U");};

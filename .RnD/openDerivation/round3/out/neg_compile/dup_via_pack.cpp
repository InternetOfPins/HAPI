...
template<typename... OO> struct Z : hapi::Chain<OO...>::template Part<T> {using Base=typename hapi::Chain<OO...>::template Part<T>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<OO...,T>>, "duplicate layer in Z");};

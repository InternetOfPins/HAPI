...
struct Z : hapi::APIOf<T,Wave<0>,WaveOf<Slot<0>>> {using Base=hapi::APIOf<T,Wave<0>,WaveOf<Slot<0>>>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<Wave<0>,WaveOf<Slot<0>>,T>>, "duplicate layer in Z");};
int main() {return Z{}.f();}

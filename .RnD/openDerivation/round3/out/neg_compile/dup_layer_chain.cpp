...
struct Y : hapi::APIOf<Term,Self,Self> {using Base=hapi::APIOf<Term,Self,Self>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<Self,Self,Term>>, "duplicate layer in Y");};

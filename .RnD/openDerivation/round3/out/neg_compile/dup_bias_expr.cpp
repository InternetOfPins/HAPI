...
struct Z : hapi::Chain<Bias<1>,Bias<0+1>>::Part<T> {using Base=hapi::Chain<Bias<1>,Bias<0+1>>::Part<T>; using Base::Base; static_assert(hapi::Distinct<hapi::Chain<Bias<1>,Bias<0+1>,T>>, "duplicate layer in Z");};
int main() {return Z{}.f();}

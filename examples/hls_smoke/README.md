...
| Intel HLS Compiler | **Not run** — integration scaffolding ready (`extra_hls_intel.py`, `[env:hls-intel]`); blocked on Intel/Altera account + Quartus Prime Lite download; will also target a different (Altera/Intel) device family, not `xc7a100t-1csg324-VVD` |
